...
/**
 * GaolShade sprite. Frame sizes come from pack config (SpriteSizeConfig), matching every
 ...
 */
public class GaolShadeSprite extends MobSprite {
	public GaolShadeSprite() {
		super();
		texture(Asset.getAssetFilePath(GeneralAsset.GAOL_SHADE));

		List<Integer> frameSizes = SpriteSizeConfig.getSizes(GeneralAsset.GAOL_SHADE);
