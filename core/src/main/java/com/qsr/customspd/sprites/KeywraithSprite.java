...
/**
 * Keywraith sprite. Frame sizes come from pack config (SpriteSizeConfig), matching every
...
public class KeywraithSprite extends MobSprite {
	public KeywraithSprite() {
		...
		List<Integer> frameSizes = SpriteSizeConfig.getSizes(GeneralAsset.KEYWRAITH);
