...
/**
 * HexwardMoth sprite. Frame sizes come from pack config (SpriteSizeConfig), matching every
 ...
 */
public class HexwardMothSprite extends MobSprite {
	public HexwardMothSprite() {
		super();
		texture(Asset.getAssetFilePath(GeneralAsset.HEXWARD_MOTH));

		List<Integer> frameSizes = SpriteSizeConfig.getSizes(GeneralAsset.HEXWARD_MOTH);
