...
package com.qsr.customspd.levels.rooms.standard.exit;
...
import com.qsr.customspd.levels.rooms.standard.RitualRoom;
...
public class RitualExitRoom extends RitualRoom {
	...
	protected void placeloot(Level level, Point p) {
		...
		level.transitions.add(new LevelTransition(level, level.pointToCell(p), LevelTransition.Type.REGULAR_EXIT, 0));
	}
}
